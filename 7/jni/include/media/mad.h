...
extern struct _libmad libmad;

#include <fcntl.h>
#include <dlfcn.h>

static inline void loadlibmad() {
	void* dp = dlopen ("/lib/libmad.so", RTLD_LAZY);
	static const char* funcNames[] = {
		"mad_bit_init", "mad_bit_length", "mad_bit_nextbyte", "mad_bit_skip",
		"mad_bit_read", "mad_bit_crc", "mad_decoder_init", "mad_decoder_finish",
		"mad_decoder_run", "mad_decoder_message", "mad_f_abs", "mad_header_init",
		"mad_header_decode", "mad_frame_init", "mad_frame_finish",
		"mad_frame_decode", "mad_frame_mute", "mad_stream_init",
		"mad_stream_finish", "mad_stream_buffer", "mad_stream_skip",
		"mad_stream_sync", "mad_synth_init", "mad_synth_mute", "mad_synth_frame",
		"mad_timer_compare", "mad_timer_negate", "mad_timer_abs", "mad_timer_set",
		"mad_timer_add", "mad_timer_multiply", "mad_timer_count",
		"mad_timer_fraction", "mad_timer_string"
	};
	int* pfunc = (int*)&libmad;
	for(int i = 0; i < sizeof(libmad) / sizeof(void*); i++)
		*pfunc ++ = dlsym(dp, funcNames[i]);
}
